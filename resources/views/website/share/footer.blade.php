...
<div class="w3-ch-sideBar w3-bar-block w3-card-2 w3-animate-right" style="display:none;right:0;" id="Search">
    <div class="rightMenu-scroll">
        ...
        <div class="cart_action px-3 py-4">
            <form class="form m-0 p-0" action="#" method="get">
        ...
        <div class="right-ch-sideBar">
            ...
            <template v-if="cart_count_total > 0">
                ...
                <div class="cart_action px-3 py-3">
                    <div class="form-group">
                        <a href="#" class="btn d-block full-width btn-dark">Checkout Now</a>
                    </div>
                    <div class="form-group">
                        <a href="#" class="btn d-block full-width btn-dark-light">Edit or View</a>
                    </div>
                </div>
            </template>
